    ...
    return (
        <section class={classes.content_container}>
            ...
            <div class={classes.text_container}>
                ...
                <div class={`${classes.info_container} ${classes.info_container_bottom}`}>
                    <div class={classes.icon_padding}>
                ...
                <div class={classes.links_container}>
                    <a class={classes.link} target="_blank" href="https://github.com/JesseLeung97">
                        <Github className={classes.link_icon}/>
                        <span class={`${classes.link_text} ${language === jp ? classes.link_text_japanese : ""}`}>{language.github}</span>
                    </a>
                    ...
                    <a class={classes.link} target="_blank" href="../JesseLeung_Resume_2022.pdf">
                    ...
                    <a class={classes.link} target="_blank" href="mailto:jessetleung@gmail.com">
